...
ным массивом. Для защиты операций с общим массивом использовать блокировки чтения-
записи. Двумерный массив описывает сад. В приложении должны работать следующие потоки:
